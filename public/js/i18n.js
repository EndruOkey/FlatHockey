...
const DICT = {
  cs: {
    ...
    // Auth & splash
    auth_login_h: 'Přihlásit se',
    auth_subtitle: 'Uložení profilu, statistiky a přátel.',
    auth_discord_btn: 'Přihlásit přes Discord',
    auth_guest_btn: 'Pokračovat bez přihlášení',
    auth_label_guest: '👤 Přihlásit se',
    dd_profile: '👤 Profil',
    dd_logout: 'Odhlásit se',
    splash_first_text: 'Vítej! Než začneš hrát, projdi rychlý tutoriál. 🏒',
    splash_tutorial: 'SPUSTIT TUTORIÁL',
    splash_discord: 'Přihlásit se přes Discord',
    splash_or: 'nebo',
    splash_guest: 'Hrát jako Host',
    profile_discord_cta: 'Přihlásit se přes Discord — uložit profil & statistiky',
    login_ok: '✅ Přihlášení úspěšné!',
    login_fail: '❌ Přihlášení selhalo: ',
    // Statistiky
    stats_title: 'Statistiky',
    stats_goals: 'Góly', stats_assists: 'Asistence', stats_saves: 'Zákroky',
    stats_games: 'Zápasy', stats_wins: 'Výhry', stats_losses: 'Prohry',
    // Sdílení lobby
    share_lobby: '🔗 Sdílet lobby',
    link_copied: '✓ Odkaz zkopírován!',
    join_found: 'Lobby nalezeno — nastav si přezdívku a klikni HOTOVO',
  },
  en: {
    ...
    // Statistiky
    stats_title: 'Stats',
    stats_goals: 'Goals', stats_assists: 'Assists', stats_saves: 'Saves',
    stats_games: 'Games', stats_wins: 'Wins', stats_losses: 'Losses',
    // Sdílení lobby
    share_lobby: '🔗 Share lobby',
    link_copied: '✓ Link copied!',
    join_found: 'Lobby found — set a nickname and click DONE',
    // Auth & splash
    auth_login_h: 'Sign in',
    auth_subtitle: 'Save profile, stats & friends.',
    auth_discord_btn: 'Sign in with Discord',
    auth_guest_btn: 'Continue as Guest',
    auth_label_guest: '👤 Sign in',
    dd_profile: '👤 Profile',
    dd_logout: 'Sign out',
    splash_first_text: 'Welcome! Before you play, complete the quick tutorial. 🏒',
    splash_tutorial: 'START TUTORIAL',
    splash_discord: 'Sign in with Discord',
    splash_or: 'or',
    splash_guest: 'Play as Guest',
    profile_discord_cta: 'Sign in with Discord — save profile & stats',
