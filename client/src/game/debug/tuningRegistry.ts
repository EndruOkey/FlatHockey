...
const BASE_REGISTRY: TuningParamMeta[] = [
  ...
  { key: 'inputDirectionTauMs', label: 'Input Direction Tau (ms)', hint: 'Jak rychle se raw WASD smer meni na plynuly inputAngle.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 20, max: 400, step: 5, recommended: true, keywords: ['input', 'direction', 'tau'] },
  { key: 'turnIntentTauMs', label: 'Turn Intent Tau (ms)', hint: 'Nabeh mezi inputAngle a turn intentem.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 20, max: 500, step: 5, recommended: true, keywords: ['turn', 'intent', 'tau'] },
  { key: 'velocityTurnResistance', label: 'Velocity Turn Resistance', hint: 'Jak moc aktualni velocity brzdi prechod do noveho smeru.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 3, step: 0.01, recommended: true, keywords: ['velocity', 'turn', 'resistance'] },
  { key: 'oppositeTurnResistance', label: 'Opposite Turn Resistance', hint: 'Extra odpor pro velke/opacne zmeny smeru.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 3, step: 0.01, recommended: true, keywords: ['opposite', 'turn', 'resistance'] },
  { key: 'redirectAccelPenalty', label: 'Redirect Accel Penalty', hint: 'Jak moc se pri redirectu oslabi accel do noveho smeru.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 3, step: 0.01, recommended: true, keywords: ['redirect', 'accel', 'penalty'] },
  { key: 'antiFlipWindowMs', label: 'Anti-Flip Window (ms)', hint: 'Krátké commit okno proti rychlemu stridani smeru.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 400, step: 5, recommended: true, keywords: ['anti-flip', 'spam', 'window'] },
  { key: 'antiFlipPenalty', label: 'Anti-Flip Penalty', hint: 'Kolik anti-flip vrstva zpomali rate/redirect pri spamu.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 1, step: 0.01, recommended: true, keywords: ['anti-flip', 'spam', 'penalty'] },
  ...
  { key: 'brakeTurnRateBoost', label: 'Brake Turn Boost', hint: 'Kolik se zvedne turn-rate pri brzde pro redirect.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 1, max: 3, step: 0.01, recommended: true, keywords: ['brake', 'turn', 'redirect'] },
