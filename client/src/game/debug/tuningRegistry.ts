...
const BASE_REGISTRY: TuningParamMeta[] = [
  ...
  { key: 'inputVectorResponsiveness', label: 'Input Vector Responsiveness (ms)', hint: 'Primary smoothing window for desired push vector.', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 10, max: 300, step: 5, recommended: true, keywords: ['input', 'vector', 'responsiveness'] },
  { key: 'inputVectorTauMs', label: 'Legacy Input Vector Tau (alias)', hint: 'Legacy alias; V4 uses inputVectorResponsiveness.', category: 'Movement', group: 'Legacy / Inactive', kind: 'number', min: 10, max: 300, step: 5, advanced: true, keywords: ['legacy', 'input', 'vector', 'tau'] },
  ...
  { key: 'forwardMaxSpeed', label: 'Forward Max Speed', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 80, max: 900, step: 1, recommended: true, keywords: ['forward', 'max', 'speed'] },
  { key: 'sideMaxSpeed', label: 'Side Max Speed', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 40, max: 900, step: 1, recommended: true, keywords: ['side', 'max', 'speed'] },
  { key: 'reverseMaxSpeed', label: 'Reverse Max Speed', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 40, max: 900, step: 1, recommended: true, keywords: ['reverse', 'max', 'speed'] },
  { key: 'turnLowSpeed', label: 'Turn Authority Low Speed', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 2, step: 0.01, recommended: true, keywords: ['turn', 'authority', 'low'] },
  { key: 'turnHighSpeed', label: 'Turn Authority High Speed', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 2, step: 0.01, recommended: true, keywords: ['turn', 'authority', 'high'] },
  { key: 'edgeTurnBonusMax', label: 'Edge Turn Bonus Max', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 1.5, step: 0.01, recommended: true, keywords: ['edge', 'turn', 'bonus'] },
  { key: 'brakeTurnBonusValue', label: 'Brake Turn Bonus', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 1, step: 0.01, recommended: true, keywords: ['brake', 'turn', 'bonus'] },
  { key: 'brakeOppositeRecovery', label: 'Brake Opposite Recovery', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 1, step: 0.01, recommended: true, keywords: ['brake', 'opposite', 'recovery'] },
  ...
  { key: 'baseLateralDamping', label: 'Base Lateral Damping', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 4, step: 0.01, recommended: true, keywords: ['lateral', 'damping', 'base'] },
  { key: 'maxLateralDamping', label: 'Max Lateral Damping', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 6, step: 0.01, recommended: true, keywords: ['lateral', 'damping', 'max'] },
  { key: 'brakeLateralDampingBonus', label: 'Brake Lateral Damping Bonus', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 4, step: 0.01, recommended: true, keywords: ['brake', 'lateral', 'damping'] },
  { key: 'carveLossStrength', label: 'Carve Loss Strength', category: 'Movement', group: 'Arc Movement', kind: 'number', min: 0, max: 2, step: 0.01, recommended: true, keywords: ['carve', 'loss'] },
  { key: 'glideDrag', label: 'Glide Drag', category: 'Movement', group: 'Brake', kind: 'number', min: 0, max: 5, step: 0.001, recommended: true, keywords: ['glide', 'drag'] },
  { key: 'moveDrag', label: 'Move Drag (V4)', category: 'Movement', group: 'Brake', kind: 'number', min: 0, max: 10, step: 0.001, recommended: true, keywords: ['move', 'drag'] },
  ...
  { key: 'chargeSpeedMul', label: 'Charge Speed Mul', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 1, max: 2.5, step: 0.01, recommended: true, keywords: ['charge', 'speed'] },
  { key: 'chargeAccelMul', label: 'Charge Accel Mul', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 1, max: 3, step: 0.01, recommended: true, keywords: ['charge', 'accel'] },
  { key: 'chargeTurnMul', label: 'Charge Turn Mul', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0.1, max: 1, step: 0.01, recommended: true, keywords: ['charge', 'turn'] },
  { key: 'chargeLateralGripMul', label: 'Charge Lateral Grip Mul', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0.1, max: 1, step: 0.01, recommended: true, keywords: ['charge', 'grip'] },
  { key: 'minHitSpeed', label: 'Min Hit Speed', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0, max: 1000, step: 1, recommended: true, keywords: ['hit', 'speed'] },
  { key: 'hitForce', label: 'Hit Force', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0, max: 1200, step: 1, recommended: true, keywords: ['hit', 'force'] },
  { key: 'hitCooldownTime', label: 'Hit Cooldown (s)', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0, max: 2, step: 0.01, recommended: true, keywords: ['hit', 'cooldown'] },
  { key: 'boardStunMinSpeed', label: 'Board Stun Min Speed', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0, max: 1200, step: 1, recommended: true, keywords: ['board', 'stun', 'speed'] },
  { key: 'boardStunDuration', label: 'Board Stun Duration (s)', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0, max: 3, step: 0.01, recommended: true, keywords: ['board', 'stun', 'duration'] },
  { key: 'postHitSpeedRetention', label: 'Post-Hit Speed Retention', category: 'Movement', group: 'Charge / Hit', kind: 'number', min: 0, max: 1, step: 0.01, recommended: true, keywords: ['hit', 'retention'] },
  ...
  { key: 'maxSpeed', label: 'Legacy Max Speed (inactive)', category: 'Movement', group: 'Legacy / Inactive', kind: 'number', min: 80, max: 900, step: 1, advanced: true, keywords: ['legacy', 'speed', 'cap'] },
  { key: 'accel', label: 'Legacy Accel (inactive)', category: 'Movement', group: 'Legacy / Inactive', kind: 'number', min: 200, max: 5000, step: 1, advanced: true, keywords: ['legacy', 'accel'] },
  ...
  { key: 'dragMove', label: 'Legacy Move Drag (inactive)', category: 'Movement', group: 'Legacy / Inactive', kind: 'number', min: 0, max: 10, step: 0.001, advanced: true, keywords: ['legacy', 'drag'] },
  ...
  { key: 'dragIdle', label: 'Legacy Idle Drag (inactive)', category: 'Movement', group: 'Legacy / Inactive', kind: 'number', min: 0, max: 5, step: 0.001, advanced: true },
