...
export const PLAYER_RIG = {
  ...
  HEAD: { forward: 15, side: 0 },
  CHEST: { forward: 3, side: 0 },
  SHOULDER_L: { forward: 3, side: -17 },
  SHOULDER_R: { forward: 3, side: 17 },
  HAND_L: { forward: 8, side: -15 },
  HAND_R: { forward: 11, side: 13 },
  HIPS: { forward: -5, side: 0 },
  NAME_TAG: { forward: 27, side: 0 },
  TORSO_BASE: { forward: -2, side: 0 },
  HEAD_RADIUS: 9,
  BODY_WIDTH: 48,
  BODY_HEIGHT: 38,
  TORSO_WIDTH: 38,
