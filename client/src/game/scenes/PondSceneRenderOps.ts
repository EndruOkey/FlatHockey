...
export function updateOverlay(scene: any) {
  ...
  setMovementDebugMetrics({
    ...
    movementModelRequested: String(telemetry.movementModelRequested ?? telemetry.movementModel ?? 'desiredHeadingTraction'),
    movementModelAuthoritative: String(telemetry.movementModelAuthoritative ?? telemetry.movementModel ?? 'desiredHeadingTraction'),
    movementModelSource: String(telemetry.movementModelSource ?? 'localPrediction'),
