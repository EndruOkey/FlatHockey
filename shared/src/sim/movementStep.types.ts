...
export type MovementStepConfig = {
  ...
  headingTurnAccel?: number;
  desiredHeadingTurnRate?: number;
  desiredHeadingTurnAccel?: number;
  brakeForce?: number;
  forwardDamping?: number;
  headingResponseCurve?: number;
  ...
  commitSpeedRelaxedThreshold?: number;
  oppositeIntentThreshold?: number;
  minHeadingAuthoritySpeed?: number;
  reverseEnterSpeed?: number;
  reverseMinDurationMs?: number;
  reverseBrakeForceMul?: number;
  reverseSteerMul?: number;
